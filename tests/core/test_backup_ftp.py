...
def _reset_global_flag():  # type: ignore[reportUnusedFunction]
...
@pytest.fixture(autouse=True)
def _patch_api_and_port():  # type: ignore[reportUnusedFunction]
...
def _ftp_info():  # type: ignore[reportUnusedFunction]
...
class TestWarnPlaintextFtp:
    ...
    def test_warn_plaintext_ftp_logs_once(self, mock_logger, _mock_ftp):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import _warn_plaintext_ftp  # type: ignore[reportPrivateUsage]
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    @patch("core.backup.ftp.logger")
    def test_warn_plaintext_ftp_sets_flag(self, mock_logger, _mock_ftp):  # type: ignore[reportMissingParameterType]
        import core.backup.ftp as mod

        with patch.object(mod, "_ftp_plaintext_warned", False):
            mod._warn_plaintext_ftp()  # type: ignore[reportPrivateUsage]
            assert mod._ftp_plaintext_warned is True  # type: ignore[reportPrivateUsage]

    @patch("core.backup.ftp.ftplib.FTP")
    @patch("core.backup.ftp.logger")
    def test_warn_plaintext_ftp_no_log_when_already_warned(self, mock_logger, _mock_ftp):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import _warn_plaintext_ftp  # type: ignore[reportPrivateUsage]
...
class TestGetRouterFtpInfo:
    def test_success(self, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
    ...
    def test_returns_none_on_exception(self, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import get_router_ftp_info
    ...
    def test_returns_none_on_key_error(self, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import get_router_ftp_info
    ...
    def test_uses_provided_port(self, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import get_router_ftp_info
    ...
    def test_returns_none_on_timeout_error(self, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import get_router_ftp_info
...
class TestDownloadFilesViaFtp:
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_single_file(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_multiple_files(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_skips_failed_file(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_skips_on_timeout_error(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_skips_on_os_error(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_skips_on_eof_error(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    def test_download_returns_empty_when_no_credentials(self, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    def test_download_returns_empty_when_credentials_none(self, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_returns_empty_on_connection_timeout(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_returns_empty_on_os_connection_error(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_returns_empty_on_ftplib_connection_error(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_returns_empty_on_login_error(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    def test_download_returns_empty_list_when_files_to_get_empty(
        self, MockFTP, _patch_api_and_port  # type: ignore[reportMissingParameterType]
    ):
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_empty_credentials_skips_connection(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    def test_download_calls_warn_plaintext(self, mock_warn, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_uses_correct_retr_command(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_local_path_uses_backup_dir(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
...
class TestUploadFileViaFtp:
    @patch("core.backup.ftp.ftplib.FTP")
    def test_upload_success(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
    ...
    def test_upload_returns_false_when_no_credentials(self, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import upload_file_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_upload_returns_false_on_connection_error(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import upload_file_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_upload_returns_false_on_timeout(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import upload_file_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_upload_returns_false_on_ftplib_error(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import upload_file_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_upload_returns_false_on_eof_error(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import upload_file_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_upload_returns_false_on_storbinary_error(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import upload_file_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    @patch("core.backup.ftp._warn_plaintext_ftp")
    def test_upload_calls_warn_plaintext(self, mock_warn, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import upload_file_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_upload_uses_correct_stor_command(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import upload_file_via_ftp
    ...
    def test_upload_returns_false_when_router_info_none(self, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import upload_file_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_upload_uses_provided_port(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import upload_file_via_ftp
...
class TestDownloadEdgeCases:
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_all_files_fail_returns_empty(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_quits_even_when_exception_occurs(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_connect_timeout_still_quits_for_cleanup(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_download_partial_failure_logs_correctly(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import download_files_via_ftp
        ...
        def fake_retr(cmd, cb):  # type: ignore[reportMissingParameterType]
            if "bad" in cmd:
...
class TestUploadEdgeCases:
    @patch("core.backup.ftp.ftplib.FTP")
    def test_upload_quits_even_when_storbinary_fails(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import upload_file_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_upload_returns_false_on_file_not_found(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import upload_file_via_ftp
    ...
    @patch("core.backup.ftp.ftplib.FTP")
    def test_upload_os_error_during_stor_returns_false(self, MockFTP, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import upload_file_via_ftp
...
class TestGetRouterFtpInfoEdgeCases:
    def test_returns_none_on_runtime_error(self, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import get_router_ftp_info
    ...
    def test_returns_none_on_value_error(self, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import get_router_ftp_info
    ...
    def test_returns_full_dict_on_success(self, _patch_api_and_port):  # type: ignore[reportMissingParameterType]
        from core.backup.ftp import get_router_ftp_info
