...
class StatsManager:
    ...
    def get_hotspot_stats(self, router_key: str) -> RouterOSRow | None:
    ...
    def format_userman_stats(self, stats: RouterOSRow | None, router_name: str) -> str:
        """Format User Manager stats dict into an Arabic display string."""
        from utils.formatters import format_userman_stats as _fmt

        return _fmt(stats, router_name)

    def format_hotspot_usage_report(self, report: RouterOSRow, router_name: str) -> str:
    ...
    def get_week_trend(self, router_key: str) -> list[RouterOSRow]:
    ...
    def format_trend_chart(self, snapshots: list[RouterOSRow]) -> str:
    ...
    def format_vs_yesterday(self, current: RouterOSRow, yesterday: RouterOSRow | None) -> str:
