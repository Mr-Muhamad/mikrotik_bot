...
CALLBACKS: dict[str, str] = {
    ...
    "search_sys_hotspot": "search_sys_hotspot",
    "search_sys_userman": "search_sys_userman",
...
PATTERNS: dict[str, str] = {
    ...
    "search_sys_hotspot": r"^search_sys_hotspot$",
    "search_sys_userman": r"^search_sys_userman$",
